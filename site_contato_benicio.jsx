      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:px-10 md:py-24">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-3 text-xl text-slate-300 md:text-2xl">PhD Student</p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-2xl border border-slate-700 bg-slate-900 px-5 py-3 text-sm font-medium text-slate-100 transition hover:bg-slate-800"
              >
                Falar no WhatsApp
              </a>
            </div>
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {contacts.map((contact) => (
            <a
              ...
              className="rounded-3xl border border-slate-800 bg-slate-900 p-6 shadow-lg transition hover:-translate-y-1 hover:bg-slate-800"
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="text-lg font-semibold text-white">{contact.title}</h3>
                  <p className="mt-2 break-all text-sm text-slate-300">{contact.value}</p>
                </div>
